<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"I:\phpstudy\WWW\myproject\public/../application/admin\view\role\edit.html";i:1526219770;s:60:"I:\phpstudy\WWW\myproject\application\admin\view\layout.html";i:1526043875;}*/ ?>
<!DOCTYPE html>
<html class="no-js">
    ...
    <div class="row-fluid">
                ...
                <div class="block">
                    ...
                    <div class="block-content collapse in">
                        <div class="span12">
                            <form  class="form-horizontal" action="<?php echo url('admin/role/update', ['id'=>$roleInfo['id']]); ?>">
                                <fieldset>
                                    <legend>基本信息</legend>
                                   <div class="control-group">
                                       <label  class="control-label" for="role_name">用户角色名称<span class="required">*</span></label>
                                       <div class="controls">
                                            <input type="text" class="input-xlarge" id="role_name" name="role_name" value="<?php echo $roleInfo['role_name']; ?>">
                                       </div>
                                   </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select multiple="multiple" id="role_auth" name="role_auth_ids[]" class="chzn-select span4">
                                                ...
                                                <?php if(is_array($authList) || $authList instanceof \think\Collection || $authList instanceof \think\Paginator): $i = 0; $__LIST__ = $authList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$auth): $mod = ($i % 2 );++$i;?>
                                                    <option value="<?php echo $auth['id']; ?>" <?php if((in_array($auth['id'],$roleInfo['auth']))): ?>selected<?php endif; ?>><?php echo $auth['auth_name']; ?>&emsp;<?php echo $auth['auth']; ?></option>
