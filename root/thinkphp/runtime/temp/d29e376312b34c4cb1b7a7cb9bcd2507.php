<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"I:\phpstudy\WWW\myproject\public/../application/admin\view\goodstype\edit.html";i:1525940300;s:60:"I:\phpstudy\WWW\myproject\application\admin\view\layout.html";i:1526043875;}*/ ?>
<!DOCTYPE html>
<html class="no-js">
    ...
    <div class="row-fluid">
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">商品类型修改</div>
                    </div>
                    <div class="block-content collapse in">
                        <div class="span12">
                            <form  class="form-horizontal" action="<?php echo url('admin/goodstype/update',['id'=>$typeInfo['id']]); ?>">
                                <fieldset>
                                    <legend>基本信息</legend>
                                   <div class="control-group">
                                       <label  class="control-label" for="goods_type">商品类型名称<span class="required">*</span></label>
                                       <div class="controls">
                                            <input type="text" class="input-xlarge" id="goods_type" name="type_name" value="<?php echo $typeInfo['type_name']; ?>">
                                       </div>
                                    </div>
