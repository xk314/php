<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"I:\phpstudy\WWW\myproject\public/../application/admin\view\manager\edit.html";i:1526214737;s:60:"I:\phpstudy\WWW\myproject\application\admin\view\layout.html";i:1526043875;}*/ ?>
<!DOCTYPE html>
<html class="no-js">
    ...
    <div class="row-fluid">
                ...
                <div class="block">
                    ...
                    <div class="block-content collapse in">
                        <div class="span12">
                            <form  class="form-horizontal" action="<?php echo url('admin/manager/update',['id'=>$userInfo['id']]); ?>">
                                <fieldset>
                                   ...
                                   <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" disabled class="input-xlarge" id="username" name="username" value="<?php echo $userInfo['username']; ?>">
                                    </div>
                                </div>
                                    <div class="control-group">
                                        <label  class="control-label" for="nickname">Nickname<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" disabled class="input-xlarge" id="nickname" name="nickname" value="<?php echo $userInfo['nickname']; ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="select01">用户状态</label>
                                        <div class="controls">
                                            <select id="select01" class="chzn-select" name="status">
                                                <option>请设置用户状态</option>
                                                <option value="注销" <?php if(($userInfo['status']=='注销')): ?>selected<?php endif; ?>>注销</option>
                                                <option value="禁用" <?php if(($userInfo['status']=='禁用')): ?>selected<?php endif; ?>>禁用</option>
                                                <option value="正常" <?php if(($userInfo['status']=='正常')): ?>selected<?php endif; ?>>正常</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="control-group">
