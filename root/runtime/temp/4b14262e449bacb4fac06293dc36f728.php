<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"I:\phpstudy\WWW\myproject\public/../application/admin\view\articlecategory\edit.html";i:1526374886;s:60:"I:\phpstudy\WWW\myproject\application\admin\view\layout.html";i:1526298807;}*/ ?>
<!DOCTYPE html>
<html class="no-js">
    ...
    <div class="row-fluid">
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">修改文章分类</div>
                        <div style="float: right"><a href="<?php echo url('admin/articlecategory/index'); ?>"><i class="icon-remove"></i></a></div>
                    </div>
                    <div class="block-content collapse in">
                        <div class="span12">
                            <form  class="form-horizontal" action="<?php echo url('admin/articlecategory/update',['id'=>$categoryInfo['id']]); ?>">
                                <fieldset>
                                   ...
                                   <div class="control-group">
                                       ...
                                       <div class="controls">
                                            <input type="text" class="input-xlarge" id="classname" name="classname" value="<?php echo $categoryInfo['classname']; ?>">
                                       </div>
                                    </div>
                                        ...
                                        <div class="controls">
                                            <select id="select01" class="chzn-select" name="pid">
                                                ...
                                                <?php if(is_array($categoryList) || $categoryList instanceof \think\Collection || $categoryList instanceof \think\Paginator): $i = 0; $__LIST__ = $categoryList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$category): $mod = ($i % 2 );++$i;?>
                                                    <option value="<?php echo $category['id']; ?>" <?php if(($categoryInfo['pid']==$category['id'])): ?>selected<?php endif; ?>><?php echo $category['classname']; ?></option>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="number" name="orderby" class="input-xlarge" id="orderby" value="<?php echo $category['orderby']; ?>" >
