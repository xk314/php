<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"I:\phpstudy\WWW\myproject\public/../application/admin\view\goodsattr\create.html";i:1525964264;s:60:"I:\phpstudy\WWW\myproject\application\admin\view\layout.html";i:1525964571;}*/ ?>
<!DOCTYPE html>
<html class="no-js">
    ...
    <div class="row-fluid">
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">商品属性新增</div>
                    </div>
                    <div class="block-content collapse in">
                        <div class="span12">
                            <form  class="form-horizontal" action="<?php echo url('admin/goodsattr/save'); ?>">
                                <fieldset>
                                    <legend>基本信息</legend>
                                   <div class="control-group">
                                       <label  class="control-label" for="goods_type">属性名称<span class="required">*</span></label>
                                       <div class="controls">
                                            <input type="text" class="input-xlarge" id="goods_type" name="attr_name" placeholder="新增属性名称">
                                       </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="select02">商品类型</label>
                                        <div class="controls">
                                            <select id="select02" name="type_id1">
                                                <option>something</option>
                                                <?php if(is_array($goodsTypeList) || $goodsTypeList instanceof \think\Collection || $goodsTypeList instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsTypeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?>
                                                <option value="<?php echo $type['id']; ?>"><?php echo $type['type_name']; ?></option>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="select02">商品属性类型</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="select02">商品属性值录入方式</label>
                                        <div class="controls">
                                            <label class="radio-inline">
                                                <input type="radio" name="attr_input_type" value="单选框"> 单选框
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="attr_input_type" value="多选框"> 多选框
                                            </label>
                                            <label class="radio-inline">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea class="" rows="3" id="attr_type" name="attr_values" placeholder="请以英文逗号隔开..." ></textarea>
                                        </div>
                                    </div>
