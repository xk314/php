...
<link href="/static/admin/login/css/style.css" rel='stylesheet' type='text/css' />
	<link href="/static/admin/login/css/shake.css" rel='stylesheet' type='text/css' />
<!--webfonts-->
...
<script type="text/javascript">
	$(function($){
        ...
        {
            $('input').eq(3).val('登录成功');
			$('form').attr('class', 'shake shake-slow shake-hover');
			setInterval(function(){$('form').attr('class','');},1000);
        }
