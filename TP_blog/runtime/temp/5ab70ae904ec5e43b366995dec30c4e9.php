                            ...
                            <form  class="form-horizontal" >
                                <fieldset>
                                   ...
                                   <div class="control-group">
                                       ...
                                       <div class="controls">
                                            <input type="text" disabled class="input-xlarge" id="title" name="title" value="<?php echo $article['title']; ?>">
                                       </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="number" disabled name="orderby" class="input-xlarge" id="orderby" value="<?php echo $article['orderby']; ?>" >
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls ">
                                            <div class="radio-inline">
                                                <label>
                                                    <input type="radio" disabled id="top" name="top" value="否" <?php if(($article['top']=='否')): ?>checked<?php endif; ?>>
                                                    否
                                                </label>
                                                <label>
                                                    <input type="radio" disabled name="top" value="是" <?php if(($article['top']=='是')): ?>checked<?php endif; ?> >
                                                    是
                                                </label>
                                            </div>
                                        </div>
